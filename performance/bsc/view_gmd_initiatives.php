...
<head>
    <meta charset="utf-8" />
    <title>Annual GMD Initiatives - Strategy | SERIS</title>
...
<body data-topbar="dark" data-layout="horizontal">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18"><i class="fas fa-align-justify"></i> GMD - VIEW BSC INITIATIVES</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-10">
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-4">
                                    <div class="text-sm">                                                
                                        <a href="annual-gmd-bsc" class="btn btn-secondary waves-effect waves-light mb-2 me-2">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-12">
                                    <p><b>Notice:</b> 
                                        <a href="assets/downloads/bsc_targets_template.csv"  download="departmental_initiatives_template.csv"  target="_blank"><i class="fa fa-file-text-o" aria-hidden="true"></i>Download and use this Template</a>, <br> 
                                    </p>
                                </div>
                            </div>
    ...
    <script src="performance/bsc/js/view_gmd_initiatives.js"></script>
</body>
