...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
    ...
    $bscInitiatives->country = $userDetails['country_id'];
    $bscInitiatives->department  = $userDetails['department_id'];
    ...
    $bscInitiatives->individual_bsc_id = isset($_POST['bscId']) ? clean_data($_POST['bscId']) : "";
    ...
    //Projects query
    $output = $bscInitiatives->read_all_individual_initiatives();
