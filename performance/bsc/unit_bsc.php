...
<head>
    <meta charset="utf-8" />
    <title>Annual Unit BSC | SERIS</title>
...
<body data-topbar="dark" data-layout="horizontal">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18"><i class="fas fa-align-justify"></i> ANNUAL UNIT BSC</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="#">Employee Performance</a> ></li>
                                        <li class="breadcrumb-item active">Unit BSC</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
    ...
    <script src="performance/bsc/js/unit_bsc.js"></script>
</body>
