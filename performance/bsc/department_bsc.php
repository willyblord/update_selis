...
<head>
    <meta charset="utf-8" />
    <title>Annual Departmental BSC | SERIS</title>
...
<body data-topbar="dark" data-layout="horizontal">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18"><i class="fas fa-align-justify"></i> ANNUAL DEPARTMENTAL BSC</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="#">Employee Performance</a> ></li>
                                        <li class="breadcrumb-item active">Departmental BSC</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="bsc_owner" class="form-label">Assignee </label>
                                            <select class="form-select select2" id="bsc_owner" name="bsc_owner">
                                            </select>
                                        </div>
                                    </div>
                                </form>
    ...
    <script src="performance/bsc/js/department_bsc.js"></script>
</body>
