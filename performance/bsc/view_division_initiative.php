...
<body data-topbar="dark" data-layout="horizontal">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18"><i class="fas fa-align-justify"></i> VIEW COUNTRY/MAIN FUNCTION BSC INITIATIVES</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-10">
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-4">
                                    <div class="text-sm">                                                
                                        <a href="annual-function-bsc" class="btn btn-secondary waves-effect waves-light mb-2 me-2">
    ...
    <script src="performance/bsc/js/view_division_initiative.js"></script>
</body>
