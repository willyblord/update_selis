...
<body data-topbar="dark" data-layout="horizontal">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18"><i class="fas fa-align-justify"></i> VIEW DEPARTMENT BSC INITIATIVES</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-10">
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-4">
                                    <div class="text-sm">                                                
                                        <a href="annual-departmental-bsc" class="btn btn-secondary waves-effect waves-light mb-2 me-2">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label for="depart_initiative_id" class="form-label">Departmental Initiative</label>
                                                <select class="form-control select2" name="depart_initiative_id" id="depart_initiative_id" required>
                                                    <option value="">...</option>
                                                </select>
                                            </div>
                                        </div>
                                        <!-- <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="initiative" class="form-label">IndividuaInitiative</label>
    ...
    <script src="performance/bsc/js/view_department_initiative.js"></script>
</body>
