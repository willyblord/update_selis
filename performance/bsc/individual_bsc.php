...
<head>
    <meta charset="utf-8" />
    <title>Annual Individual BSC| SERIS</title>
...
<body data-topbar="dark" data-layout="horizontal">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18"><i class="fas fa-align-justify"></i> ANNUAL INDIVIDUAL BSC</h4>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="text-sm">
                                                            <button type="button" id="add_button"
                                                                ...
                                                                <i class="mdi mdi-plus me-1"></i> Add Annual BSC
                                                            </button>
                                                        </div>
                                                    </div>
                                                    <!-- end col-->
    ...
    <script src="performance/bsc/js/individual_bsc.js"></script>
</body>
