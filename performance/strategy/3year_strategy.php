...
<body data-topbar="dark" data-layout="horizontal">
        ...
        <div class="main-content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18"><i class="fas fa-align-justify"></i> 3 YEAR STRATEGY</h4>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="text-sm">
                                                <button type="button" id="add_button"
                                                    ...
                                                    <i class="mdi mdi-plus me-1"></i> Add 3 Year Strategy
                                                </button>
                                            </div>
                                        </div>
                                        <!-- end col-->
            ...
            <div class="modal fade addModal modals" id="addModal" data-bs-backdrop="static"
                ...
                <div class="modal-dialog modal-lg">
                    <form method="post" id="strategy_form" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control" name="fromYear" id="fromYear" required>
                                                    <option>...</option>
                                                    <option>2020</option>
                                                    <option>2021</option>
                                                    <option>2022</option>
    ...
    <script src="performance/strategy/js/3year_strategy.js"></script>
</body>
