...
<head>
    <meta charset="utf-8" />
    <title>Annual Group Strategy | SERIS</title>
...
<body data-topbar="dark" data-layout="horizontal">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18"><i class="fas fa-align-justify"></i> ANNUAL GROUP STRATEGIES</h4>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="card shadow-lg">
                                            <h6 class="card-header bg-secondary text-white border-bottom text-uppercase">Department Details</h6>
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <table id="" class="table table-borderless table-responsive table-hover table-condensed">
                                                        ...
                                                        <tr style="color:#b01c2e; font-weight: bold;">
                                                            ...
                                                            <td><center id="act_division_name">Loading...</center></td>
    ...
    <script src="performance/strategy/js/group_initiatives.js"></script>
</body>
