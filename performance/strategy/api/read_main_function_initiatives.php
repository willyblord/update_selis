...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
    ...
    $businessInitiative->country = $mycountry;
    $businessInitiative->department  = $my_department;
    $businessInitiative->division  = $my_division_id;
    ...
    //Projects query
    $output = $businessInitiative->read_all_department_initiatives();
