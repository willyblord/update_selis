...
<head>
    <meta charset="utf-8" />
    <title>HOD - PettyCash | SERIS</title>
...
<body data-topbar="dark" data-layout="horizontal">
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <button type="button" class="btn btn-danger waves-effect waves-light "
                                        data-bs-toggle="modal" data-bs-target=".budgetLinesModal">BUDGET LINES (<b id="autoDepartPercent">Loading...</b> SPENT) 
                                    </button>
                                    <button type="button" id="hod_bal_button" class="btn btn-primary waves-effect waves-light "
                                        data-bs-toggle="modal" data-bs-target=".budgetTopupModal">BUDGET TOPUP REQUESTS
                                    </button>
            ...
            <div class="modal fade budgetLinesModal" id="budgetLinesModal" data-bs-backdrop="static"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="budget_to_increase" class="form-label">Budget To Increase</label>
    ...
    <script src="funds/pettycash/js/hod.js"></script>
</body>
