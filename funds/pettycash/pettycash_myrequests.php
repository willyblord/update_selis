...
<head>
    <meta charset="utf-8" />
    <title>MyRequests - PettyCash | SERIS</title>
...
<body data-topbar="dark" data-layout="horizontal">
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18"><i class="fas fa-align-justify"></i> My
                                    Requests</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="text-sm">
                                                <button type="button" id="add_button"
                                                    ...
                                                    <i class="mdi mdi-plus me-1"></i> Add Request
                                                </button>
                                            </div>
                                        </div>
                                        <!-- end col-->
                                    ...
                                    <table id="request_data"
                                        class="table table-condensed table-hover dt-responsive w-100"
            ...
            <!-- Transaction Modal -->
            <div class="modal fade addRequestModal modals" id="addRequestModal" data-bs-backdrop="static"
                data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <form method="post" id="my_request_form" enctype="multipart/form-data">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group" id="datepicker1">
                                                    <input type="text" class="form-control"
                                                        ...
                                                        autocomplete="off" name="visitDate" id="visitDate">
                                    ...
                                    <div class="row" id="otherServer" style="display:none">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="mb-3">
                                                <label for="providers">Add Providers</label>
                                                <select class="form-control select2" multiple name="providers[]"
                                                    id="providers">
                                                </select>
                                    ...
                                    <div class="row" id="otherServer1" style="display:none">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="mb-3">
                                                <label for="customers">Add Customers</label>
                                                <select class="form-control select2" multiple name="customers[]"
                                                    id="customers">
                                                </select>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                    ...
                                    <div class="row" id="transAcc" style="display:none">
                                        <div class="col-sm-12 col-md-4">
                                            <div class="mb-3">
                                                <label for="transport">Transport</label>
                                                <input type="number" min="0" class="form-control inputT"
                                                    name="transport" id="transport" value="0"
                                                    data-error="Amount is required" required>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" min="0" class="form-control inputT"
                                                    name="accomodation" id="accomodation" value="0"
                                                    data-error="Amount is required" required>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" min="0" class="form-control inputT" name="meals"
                                                    id="meals" value="0" data-error="Amount is required" required>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="other" id="otherAmountInput">Amount</label>
                                                <input type="number" min="0" class="form-control inputT" name="other"
                                                    id="other" value="0" data-error="Amount is required" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="requester_charges">Transfer Charges(if any)</label>
                                                <input type="number" min="0" class="form-control inputT"
                                                    name="requester_charges" id="requester_charges" value="0"
                                                    data-error="Amount is required" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" min="0" class="form-control" name="amount"
                                                    id="amount" value="0" readonly data-error="Amount is required"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" id="checkinCheckout" style="display:none">
                                        <div class="col-md-12 col-lg-12">
                                            <div class="mb-3">
                                                <label class="col-form-label">Departure and Return Date</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="additional_doc">Additional Doc [pdf, word, excel]
                                                    (optional)</label>
                                                <input type="file" class="form-control" name="additional_doc"
                                                    id="additional_doc"
                                                    accept=".xlsx,.xls,.doc,.docx,.pdf,.XLSX,.XLS,.DOC,.DOCX,.PDF">
                                                <div class="help-block with-errors"></div>
                                                <span id="thumbnail_doc"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="phone">Mobile Money Number (Optional)</label>
            ...
            <div class="modal fade actionModal" id="actionModal" data-bs-backdrop="static" data-bs-keyboard="false"
                tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="card shadow-lg">
                                            <h6
                                                class="card-header bg-secondary text-white border-bottom text-uppercase">
                                                Request Details</h6>
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <table
                                                        class="table table-bordered table-responsive table-hover table-condensed">
                                                        <tbody>
                                                            <tr>
                                                                <th>Ref.Number</th>
                                                                <th>Category</th>
    ...
    <script src="funds/pettycash/js/myrequests.js"></script>
</body>
