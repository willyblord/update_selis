...
if ($row['can_be_super_user'] != 1 && $row['can_be_cash_finance'] != 1) {
...
<head>
    <meta charset="utf-8" />
    <title>Finance - PettyCash | SERIS</title>
...
<body data-topbar="dark" data-layout="horizontal">
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18"><i class="fas fa-align-justify"></i> Finance Operations </h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-10">
                            <div class="card">
                                <div class="card-body">
                                    <button type="button" id="fina_bal_button"
                                        class="btn btn-danger waves-effect waves-light "
                                        data-bs-toggle="modal" data-bs-target=".rechargeModal">
                                        CASHBOX :: BALANCE = <span id="autoFinaBal"></span>
                                    </button>
                                    <button type="button"
                                        class="btn btn-primary waves-effect waves-light "
                                        data-bs-toggle="modal" data-bs-target=".rechargeLogsModal">
                                        CASHBOX LOGS
                                    </button>
                                    <?php if ($is_on_budget) { ?>
                                    <button type="button"
            ...
            <div class="modal fade rechargeModal modals" id="rechargeModal" data-bs-backdrop="static"
                data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
                <div class="modal-dialog">
                    <form method="post" id="recharge_form" enctype="multipart/form-data">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="transaction-detailModalLabel">
                                Cashbox TopUp/Withdraw
                                </h5>
                            ...
                            <div class="modal-body">                            
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="category" class="form-label">Select Action</label>
                                            <select class="form-select " id="category" name="category" required>
                                                <option value="">...</option>
                                                <option value="recharge">Recharge Account</option>
            ...
            <div class="modal fade rechargeLogsModal modals" id="rechargeLogsModal" data-bs-backdrop="static"
                data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="table-responsive"> 
                                <table id="fina_logs_data" class="table table-condensed table-hover dt-responsive w-100" style="font-size: 12px;">
                                    <thead>
                                        <tr>
    ...
    <script src="funds/pettycash/js/finance.js"></script>
</body>
