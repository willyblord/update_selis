...
<head>
    <meta charset="utf-8" />
    <title>PettyCash Report | SERIS</title>
...
<body data-topbar="dark" data-layout="horizontal">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18"><i class="fas fa-align-justify"></i> Petty Cash Report</h4>
                                ...
                                <div class="card-body">
                                    <form method="post" id="filter_form" autocomplete="off"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="mb-3">
                                                    <label for="budget_category" class="form-label">BUDGET LINE</label>
                                                    <select class="form-select select2" id="budget_category" name="budget_category">
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select select2" id="cashCategory" name="cashCategory">
                                            ...
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select select2" id="statusCheck" name="statusCheck">
                                            ...
                                            <div class="col-md-2">
                                                <div class="mb-3">
                                                    <label for="cashReqBy" class="form-label">REQUEST BY </label>
                                                    <select class="form-select select2" id="cashReqBy" name="cashReqBy">
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="mb-3">
                                                    <label for="cashDisbBy" class="form-label">DISBURSED BY </label>
                                                    <select class="form-select select2" id="cashDisbBy" name="cashDisbBy">
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <table id="data_table" class="table table-hover dt-responsive w-100" style="font-size: 0.80em; cursor:pointer">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td colspan="9"><center><b>No Data to display</b></center></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
    ...
    <script src="funds/pettycash/js/report.js"></script>
</body>
