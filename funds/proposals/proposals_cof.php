...
<body data-topbar="dark" data-layout="horizontal">
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18"><i class="fas fa-align-justify"></i> CFO</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="#"> CFO</a> ></li>
                        ...
                        <div class="col-sm-12 col-lg-10">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table id="table_data" class="table table-condensed table-hover dt-responsive w-100"
            ...
            <!-- End Page-content -->
            <div class="modal fade addModal modals" id="addModal" data-bs-backdrop="static" data-bs-keyboard="false"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group" id="datepicker1">
                                                <input type="text" class="form-control" data-date-format="yyyy-mm-dd"
                                                    ...
                                                    data-date-autoclose="true" name="proposal_date" id="proposal_date">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="basicpill-address-input"> Objective
                                                & Business
                                                Case</label>
                                            <textarea class="form-control" rows="4" name="objective"
                                ...
                                <div id="dynamicAddRemove">
                                    <div class="row">
                                        <div class="col-sm-2 mb-3 mb-sm-0">
                                            ...
                                            <input type="text" placeholder="Enter Item" id="item" name="item[]"
                                                class="form-control">
                                        </div>
                                        <div class="col-sm-2 mb-3 mb-sm-0">
                                        ...
                                        <div class="col-sm-2 mb-3 mb-sm-0">
                                            ...
                                            <input type="number" id="price" value="0" name="price[]"
                                                class="form-control price">
                                        </div>
                                        <div class="col-sm-2 mb-3 mb-sm-0">
                                            <label for="total">Total</label>
                                            <input type="number" id="total" value="0" name="total[]"
                                        ...
                                        <div class="col-sm-2 mb-3 mb-sm-0">
                                            ...
                                            <span class="btn btn-primary circle" id="repeatForm"> <i class="fa fa-plus"
                                ...
                                <section>
                                    <div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label for="basicpill-cardno-input">Attach
                                                        File
                                                        /
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="card" id="display_document" style="display: none;">
                                ...
                                <div class="card-body">
                                    <span id="view_additional_doc"></span>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header">
                                                    ...
                                                    <table
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><span id="prop_budget"></span></td>
                                                                <td><span id="prop_totalAmount"></span></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                                            ...
                                                            <div class="text-muted">
                                                                <table
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <th>Department</th>
                                                                            <th>Badget Category</th>
                                                                            <th style="color: #b01c2e">Remaining Amount
                                                                            </th>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><span id="prop_department"></span></td>
                                                                            <td><span id="prop_budget2"></span></td>
                                                                            <td><span id="prop_budgettotal"
                                                                                    style="color: #b01c2e"></span></td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
            ...
            <!-- amend -->
            <div class="modal fade actionModal" id="actionModal2" data-bs-backdrop="static" data-bs-keyboard="false"
                tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <form method="post" id="this_form2" enctype="multipart/form-data">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="transaction-detailModalLabel">
                                    Modal Title
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                                ...
                                                <div class="table-responsive">
                                                    <table
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td><span id="rprop_refNo"></span></td>
                                                                <td><span id="rprop_subject"></span></td>
                                                                <td><span id="rprop_totalAmount"></span></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                        ...
                                        <div class="card shadow-lg">
                                            <h6 class="card-header bg-secondary text-white border-bottom text-uppercase"
                                                id="action_title2">Action</h6>
                                            <div class="card-body" id="action_body2">
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="funds/proposals/js/cof.js"></script>
</body>
