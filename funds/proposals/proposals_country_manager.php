...
<head>
    <meta charset="utf-8" />
    <title>Country Manager - Proposals | SERIS</title>
...
<body data-topbar="dark" data-layout="horizontal">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18"> <i class="fas fa-align-justify"></i> COUNTRY MANAGER
                                    Proposals </h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="#">Proposals </a> ></li>
                                        <li class="breadcrumb-item active">COUNTRY MANAGER</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
    ...
    <script src="funds/proposals/js/com.js"></script>
</body>
