...
$(document).ready(function () {
    ...
    $(document).on('click', '.activateCOO', function () {
        var id = $(this).attr("id");
            ...
            success: function (res) {
                if (res.success) {
                    ...
                    var action_body =
                        ...
                        '<div class="mb-3 mt-2">' +
                        '<textarea class="form-control" rows="4" name="comment" id="comment" value="No comment"></textarea>' +
                        '</div>' +
                        '</div>' +
                        '</div>';
    ...
    var dataTable = $('#table_data').DataTable({
        ...
        'serverMethod': 'Post',
        'ajax': {
            'url': 'api/get-proposal-countryManager'
        },
        'columns': [
            { data: 'refNo' },
            { data: 'subject' },
