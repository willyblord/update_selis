...
// (A) ACCESS CHECK
include "../../protect.php";
if ($row['can_be_super_user'] != 1 && $row['can_be_cash_hod'] != 1) {
...
<head>
    <meta charset="utf-8" />
    <title>Finance - Proposals | SERIS</title>
...
<body data-topbar="dark" data-layout="horizontal">
    ...
    <div id="layout-wrapper">
        ...
        <div class="main-content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18"> <i class="fas fa-align-justify"></i> Finance
                                    Proposals </h4>
                            ...
                            <!-- <div class="card">
                                <div class="card-body">
                                    <button type="button" class="btn btn-danger waves-effect waves-light "
                                        data-bs-toggle="modal" data-bs-target=".budgetLinesModal">BUDGET LINES (<b
                                            id="autoDepartPercent">Loading...</b> SPENT)
                                    </button>
                                    <button type="button" id="hod_bal_button"
                                        class="btn btn-primary waves-effect waves-light " data-bs-toggle="modal"
                                        data-bs-target=".budgetTopupModal">BUDGET TOPUP REQUESTS
                                    </button>
                                    <button type="button" id="hod_req_button"
                                        class="btn btn-primary waves-effect waves-light " data-bs-toggle="modal"
                                        data-bs-target=".budgetRequestsModal">BUDGET LINE REQUESTS LOGS
                                    </button>
                                </div>
                            </div> -->
                            <div class="card">
            ...
            <div class="modal fade budgetTopupModal modals" id="budgetTopupModal" data-bs-backdrop="static"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select select2" id="budget_to_deduct"
                                                name="budget_to_deduct">
                                                <option value="">...</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="budget_to_increase" class="form-label">Budget To
                                                Increase</label>
                                            <select class="form-select select2" id="budget_to_increase"
                                                name="budget_to_increase">
                                                <option value="">...</option>
                                            </select>
                                        </div>
                                    </div>
    ...
    <script src="funds/proposals/js/finance.js"></script>
</body>
<style type="text/css">
.circle {
    width: 50px;
