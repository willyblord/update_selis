<?php
    ...
    class User {
        ...
        public $can_be_super_user;
        public $can_add_user;
        public $can_view_user;
        public $can_edit_user;
        public $can_deactivate_user;
        public $can_reset_user_password;
        public $can_delete_user;
        public $can_give_privileges;
        public $can_see_settings;
        public $can_update_notifications;
        
        public $can_be_country_manager;
        public $can_be_exco;
        public $can_be_gmd;
        public $can_be_coo;
        
        public $can_add_activity;
        public $can_be_activity_hod;
        public $can_be_activity_coo;
        public $can_be_activity_country_manager;
        public $can_be_activity_md;
        public $can_view_activities_reports;
        
        public $can_be_incident_pro_manager;
        public $can_view_incident_reports;
        
        public $can_add_ideas;
        public $can_do_ideas_funneling;
        public $can_do_ideas_sharktank;
        public $can_view_ideas_reports;
        
        public $can_add_booking;
        public $can_be_approver;
        public $can_view_book_reports;
        
        public $can_add_cash_requests;
        public $can_be_cash_hod;
        public $can_be_cash_coo;
        public $can_be_cash_manager;
        public $can_prosess_flight;
        public $can_be_cash_finance;
        public $can_view_cash_reports;
        
        public $can_add_equip_requests;
        public $can_be_equip_hod;
        public $can_be_equip_inn;
        public $can_be_equip_country_manager;
        public $can_be_equip_coo;
        public $can_be_equip_operations;
        public $can_be_equip_gmd;
        public $can_view_equip_reports;
        
        public $can_view_monitoring_tasks;
        public $can_be_monitoring_pro_manager;
        public $can_view_monitoring_reports;
        public $can_view_my_minutes;
        public $can_add_all_minutes;
        public $can_view_minute_reports;

        public $can_view_copay;
        public $can_add_copay;
        public $can_activate_copay;
        public $can_view_copay_reports;

        public $can_add_strategy_bsc;
        public $can_be_strategy_hod;
        public $can_be_strategy_division;
        public $can_be_strategy_hr;
        ...
        public function get_user($userId,$OTP){
            $query =  'SELECT u.*, p.*, u.userId AS userId, d.category AS dept_name FROM '.$this->table.' u
                        LEFT JOIN privileges p ON u.userId = p.userId
                        LEFT JOIN department_categories d ON u.department = d.id
                        WHERE u.userId = :userId AND OTP = :OTP AND u.status IN("active")
                    ';
            $stmt = $this->conn->prepare($query);
            $stmt->bindParam(':userId', $userId);
            $stmt->bindParam(':OTP', $OTP);
            ...
            if ($valid) {
                ...
                foreach($result as $row) 
                {
                    return array(
                        ...
                        'surname' 		        => $row["surname"],
                        'country' 		        => $row["country"],
                        'my_staff_number' 		=> $row["staffNumber"],
                        'email' 		        => $row["email"],
                        'department'			=> $row["dept_name"],
                        'department_val'		=> $row["department"],
                        'can_be_super_user'     => $row["can_be_super_user"],
                        'can_add_user'          => $row["can_add_user"],
                        'can_view_user' 		=> $row["can_view_user"],
                        'can_edit_user' 		=> $row["can_edit_user"],
                        'can_deactivate_user' 	=> $row["can_deactivate_user"],
                        'can_reset_user_password'=> $row["can_reset_user_password"],
                        'can_delete_user' 		 => $row["can_delete_user"],
                        'can_give_privileges' 	 => $row["can_give_privileges"],
                        'can_see_settings' 		 => $row["can_see_settings"],
                        'can_update_notifications' => $row["can_update_notifications"],
                        
                        'can_be_country_manager' => $row["can_be_country_manager"],
                        'can_be_exco' => $row["can_be_exco"],
                        'can_be_gmd' => $row["can_be_gmd"],
                        'can_be_coo' => $row["can_be_coo"],
                        
                        'can_add_activity' => $row["can_add_activity"],
                        'can_be_activity_hod' => $row["can_be_activity_hod"],
                        'can_be_activity_coo' => $row["can_be_activity_coo"],
                        'can_be_activity_country_manager' => $row["can_be_activity_country_manager"],
                        'can_be_activity_md' => $row["can_be_activity_md"],
                        'can_view_activities_reports' => $row["can_view_activities_reports"],
                        
                        'can_be_incident_pro_manager' => $row["can_be_incident_pro_manager"],
                        'can_be_incident_pro_manager' => $row["can_be_incident_pro_manager"],
                        
                        'can_add_ideas' => $row["can_add_ideas"],
                        'can_do_ideas_funneling' => $row["can_do_ideas_funneling"],
                        'can_do_ideas_sharktank' => $row["can_do_ideas_sharktank"],
                        'can_view_ideas_reports' => $row["can_view_ideas_reports"],
                        
                        'can_add_booking' => $row["can_add_booking"],
                        'can_be_approver' => $row["can_be_approver"],
                        'can_view_book_reports' => $row["can_view_book_reports"],
                        
                        'can_add_cash_requests' => $row["can_add_cash_requests"],
                        'can_be_cash_hod' => $row["can_be_cash_hod"],
                        'can_be_cash_coo' => $row["can_be_cash_coo"],
                        'can_be_cash_manager' => $row["can_be_cash_manager"],
                        'can_prosess_flight' => $row["can_prosess_flight"],
                        'can_be_cash_finance' => $row["can_be_cash_finance"],
                        'can_view_cash_reports' => $row["can_view_cash_reports"],
                        
                        'can_add_equip_requests' => $row["can_add_equip_requests"],
                        'can_be_equip_hod' => $row["can_be_equip_hod"],
                        'can_be_equip_inn' => $row["can_be_equip_inn"],
                        'can_be_equip_country_manager' => $row["can_be_equip_country_manager"],
                        'can_be_equip_coo' => $row["can_be_equip_coo"],
                        'can_be_equip_operations' => $row["can_be_equip_operations"],
                        'can_be_equip_gmd' => $row["can_be_equip_gmd"],
                        'can_view_equip_reports' => $row["can_view_equip_reports"],
                        
                        'can_view_monitoring_tasks' => $row["can_view_monitoring_tasks"],
                        'can_be_monitoring_pro_manager' => $row["can_be_monitoring_pro_manager"],
                        'can_view_monitoring_reports' => $row["can_view_monitoring_reports"],
                        'can_view_my_minutes' => $row["can_view_my_minutes"],
                        'can_add_all_minutes' => $row["can_add_all_minutes"],
                        'can_view_minute_reports' => $row["can_view_minute_reports"],
                        'can_view_copay' => $row["can_view_copay"],
                        'can_add_copay' => $row["can_add_copay"],
                        'can_activate_copay' => $row["can_activate_copay"],
                        'can_view_copay_reports' => $row["can_view_copay_reports"],
                        
                        'can_add_strategy_bsc' => $row["can_add_strategy_bsc"],
                        'can_be_strategy_hod' => $row["can_be_strategy_hod"],
                        'can_be_strategy_division' => $row["can_be_strategy_division"],
                        'can_be_strategy_hr' => $row["can_be_strategy_hr"],
                    );
                }
        ...
        public function read_users(){
            ...
            if(isset($this->searchValue)){
                $searchQuery = ' AND (
                    ...
                    u.role LIKE "%'.$this->searchValue.'%" OR 
                    d.category LIKE "%'.$this->searchValue.'%" OR 
            ...
            $query = ' SELECT
                        ...
                        c.country AS pays, d.category AS dept_name
                    FROM
                        '.$this->table.' u
                    LEFT JOIN 
                        users u1 ON u.registeredBy = u1.userId
        ...
        public function read_single() {
            ...
            $this->country_val = $row['country'];
            $this->department = $row['dept_name'] ? $row['dept_name'] : 'N/A';
