...
$requiredPermissions = ['view_user', 'view_role', 'view_approval', 'view_permission', 'manage_hierarchy'];
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="division" class="form-label">Division / Main Function <span class="text-danger">*</span></label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select select2" multiple id="roles" name="roles[]">
                                                    <option value="">...</option>
                                                </select>
                                            </div>
                                        </div>
