...
<head>
        ...
        <meta charset="utf-8" />
        <title>Items & Prices | UPCE Valuation System</title>
    ...
    <!-- <body data-layout="horizontal" data-topbar="dark"> -->
        ...
        <div id="layout-wrapper">
            ...
            <div class="main-content">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="row mb-2">
                                            <div class="col-sm-4">
                                                <div class="text-sm">
                                                    <button type="button" id="add_button" class="btn btn-primary waves-effect waves-light mb-2 me-2" data-bs-toggle="modal" data-bs-target=".addItemModal"><i class="mdi mdi-plus me-1"></i> New Item</button>
                                                </div>
                                            </div><!-- end col-->
                                        </div>
                                        
                                        <table id="item_data" class="table table-hover dt-responsive w-100 ">
                                            <thead>
                                                <tr>
                                                    <th>Item Name</th>
                                                    <th>Grouping Name</th>
                ...
                <!-- Transaction Modal -->
                <div class="modal fade addItemModal modals" id="addItemModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-labelledby="" aria-hidden="true">
                    <div class="modal-dialog" >
                        <form method="post" id="item_form" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    <form class="needs-validation" novalidate>
                                        <div class="row">                                            
                                            <div class="col-sm-12">
                                                <div class="mb-3">
                                                    <label for="grouping_id" class="form-label">Grouping Name</label>
                                                    <select class="form-select select2" id="grouping_id" name="grouping_id" >
                                                        <option value="">...</option>
                                                    </select>
