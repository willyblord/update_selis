<?php 
    ...
    if ($_SERVER["REQUEST_METHOD"] == 'GET') {
        ...
        $query = 'SELECT DISTINCT d.category AS dptName, d.id AS deptId
                    FROM divisions_departments dd
                        LEFT JOIN divisions dv ON dd.division_id = dv.id
                        LEFT JOIN department_categories d ON dd.department = d.id
                        WHERE dv.id = '.$my_division_id.'
                ';
