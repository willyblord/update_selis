...
if ($_SERVER["REQUEST_METHOD"] == 'GET') {
    ...
    $all = false;
    if (($userDetails['can_be_super_user'] == 1) || (($userDetails['can_view_cash_reports'] == 1) && ($userDetails['can_be_cash_finance'] == 1 || $user_details['can_be_cash_coo'] == 1 || $user_details['can_be_cash_manager'] == 1))) {
